...
start_link() ->
    Dispatch = cowboy_router:compile([
		{'_', [
            ...
            {"/api/V2/external", api_handler, #{} },
            {"/api/V2/external/:id", api_handler, #{}},
            {"/api/V2/external/:id/:sub", api_handler, #{}},
            {"/api/V2/externals", plural_api_handler, #{}},
            {"/api/V2/externals/:sub", plural_api_handler, #{}},
            ...
            {"/api/V2/link", api_handler, #{} },
            {"/api/V2/link/:id", api_handler, #{}},
            {"/api/V2/links", plural_api_handler, #{}},
            {"/api/V2/links/:sub", plural_api_handler, #{}},
            ...
            {"/api/V2/profile", api_handler, #{}},
            {"/api/V2/profile/:id", api_handler, #{}},
            {"/api/V2/profile/:id/:sub", api_handler, #{}},
            {"/api/V2/profiles", plural_api_handler, #{}},
            {"/api/V2/profiles/:sub", plural_api_handler, #{}},
            ...
            {"/api/V2/zone/", api_handler, #{}},
            {"/api/V2/zone/:id", api_handler, #{}},
            {"/api/V2/zones", plural_api_handler, #{}},
            {"/api/V2/zones/:sub", plural_api_handler, #{}},
            {"/api/V2/zones/ips", plural_api_handler, #{}}
		]}
	]),
