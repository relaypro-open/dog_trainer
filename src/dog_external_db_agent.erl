...
-spec add_group(EnvName :: binary(), GroupName :: binary()) ->
    {ok, Env :: map()} | {error, Reason :: atom()}.
add_group(EnvName, GroupName) ->
    gen_server:call(?MODULE, {add_group, EnvName, GroupName}).

-spec remove_group(EnvName :: binary(), GroupName :: binary()) ->
    {ok, Env :: map()} | {error, Reason :: atom()}.
remove_group(EnvName, GroupName) ->
    gen_server:call(?MODULE, {remove_group, EnvName, GroupName}).

-spec get_group(EnvName :: binary(), GroupName :: binary()) ->
    {ok, Group :: list()} | {error, Reason :: atom()}.
...
-spec add_entry(EnvName :: binary(), GroupName :: binary(), Entry :: binary()) ->
    {ok, Group :: list()} | {error, Reason :: atom()}.
add_entry(EnvName, GroupName, Entry) ->
    gen_server:call(?MODULE, {add_entry, EnvName, GroupName, Entry}).

-spec remove_entry(EnvName :: binary(), GroupName :: binary(), Entry :: binary()) ->
    {ok, Group :: list()} | {error, Reason :: atom()}.
