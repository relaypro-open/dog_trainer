    ...
    case Result of
        ...
        _ ->
            ...
            lists:foreach(
                fun(Entry) ->
                    OldGroupNames =
                        case maps:get(<<"old_val">>, Entry) of
                            null ->
                                [];
                            _ ->
                    ...
                    ?LOG_INFO(#{message => "groups_updated_due_to_change_in_host_active_state", group_names => GroupNames}),
                    case Hostkeys of
                        [] ->
                            pass;
                        _ ->
                    ...
                    case GroupNames of
                        ...
                        _ ->
                            ...
                            ?LOG_INFO(#{message => "add_to_queue", group_names => GroupNames}),
