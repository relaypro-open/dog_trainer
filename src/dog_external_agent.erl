...
set_link_state(
    ...
    ?LOG_INFO(#{"message" => "New link state", "env_name" => EnvName, "enabled_state" =>
                EnabledState, "new_enabled_state" => NewEnabledState, "direction_state" =>
                DirectionState, "new_direction_state" => NewDirectionState}),
    ExternalId =
...
handle_info(Info, State) ->
    ?LOG_ERROR(#{"info" => Info, "message" => "unknown_message", "state" => State}),
    {noreply, State}.
