...
dog_state(Group,Hostname,Location,Environment,Hostkey,Interfaces,Version,Hash4Ipsets,Hash6Ipsets,Hash4Iptables,Hash6Iptables,Provider,UpdateType,IpsetHash) ->
    #dog_state{ group=Group,
                name=Hostname,
                location=Location,
